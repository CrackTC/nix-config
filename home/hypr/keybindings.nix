{
  wayland.windowManager.hyprland.settings = {
    ...
    bind = [
      ...
      "$mainMod, O, exec, rofi -show run"
      "$mainMod, Semicolon, exec, rofi-rbw"
      "$mainMod, K, exec, rofi -show calc -modi calc -no-show-match -no-sort -calc-command \"echo -n '{result}' | wl-copy\""
