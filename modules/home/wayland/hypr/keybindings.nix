      ...
      lib.mkMerge [
        ...
        ''
          ${lib.concatStringsSep "\n" [
            ...
            (mkBind "SUPER + Comma" "hl.dsp.focus({ workspace = 'name:,' })")
            (mkBind "SUPER + Escape" "hl.dsp.focus({ workspace = 'name:`' })")
            (mkBind "SUPER + A" "hl.dsp.focus({ workspace = 'name:A' })")
            (mkBind "SUPER + Z" "hl.dsp.focus({ workspace = 'name:Z' })")
            (mkBind "SUPER + B" "hl.dsp.focus({ workspace = 'name:B' })")
            (mkBind "SUPER + M" "hl.dsp.focus({ workspace = 'name:M' })")
            (mkBind "SUPER + ${if colemak then "S" else "D"}" "hl.dsp.focus({ workspace = 'name:D' })")
            (mkBind "SUPER + ${if colemak then "L" else "U"}" "hl.dsp.focus({ workspace = 'name:U' })")
            (mkBind "SUPER + W" "hl.dsp.focus({ workspace = 'name:W' })")
            (mkBind "SUPER + ${if colemak then "F" else "E"}" "hl.dsp.focus({ workspace = 'name:E' })")
            (mkBind "SUPER + SHIFT + Comma" "hl.dsp.window.move({ workspace = 'name:,' })")
            (mkBind "SUPER + SHIFT + Escape" "hl.dsp.window.move({ workspace = 'name:`' })")
            (mkBind "SUPER + SHIFT + A" "hl.dsp.window.move({ workspace = 'name:A' })")
            (mkBind "SUPER + SHIFT + Z" "hl.dsp.window.move({ workspace = 'name:Z' })")
            (mkBind "SUPER + SHIFT + B" "hl.dsp.window.move({ workspace = 'name:B' })")
            (mkBind "SUPER + SHIFT + M" "hl.dsp.window.move({ workspace = 'name:M' })")
            (mkBind "SUPER + SHIFT + ${if colemak then "S" else "D"}" "hl.dsp.window.move({ workspace = 'name:D' })")
            (mkBind "SUPER + SHIFT + ${if colemak then "L" else "U"}" "hl.dsp.window.move({ workspace = 'name:U' })")
            (mkBind "SUPER + SHIFT + W" "hl.dsp.window.move({ workspace = 'name:W' })")
            (mkBind "SUPER + SHIFT + ${if colemak then "F" else "E"}" "hl.dsp.window.move({ workspace = 'name:E' })")
