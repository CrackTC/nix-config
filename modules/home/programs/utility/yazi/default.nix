{ config, lib, ... }:
let cfg = config.programs.utility.yazi; in {
    ...
    programs.yazi = {
      ...
      keymap = {
        manager.keymap = [
          ...
          { on = [ "n" ]; run = "arrow 1"; }
          { on = [ "e" ]; run = "arrow -1"; }
          { on = [ "d" "d" ]; run = "arrow -99999999"; }
          { on = [ "D" ]; run = "arrow 99999999"; }
          { on = [ "<A-k>" ]; run = "seek 5"; }
          { on = [ "<A-;>" ]; run = "seek -5"; }
          { on = [ "h" ]; run = "leave"; }
